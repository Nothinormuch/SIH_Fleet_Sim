...
Historical September 6 release record. The September 23 collaboration integration
retains the newer collaboration defaults (BIOS7 on Chokepoint, BIOS6 elsewhere)
and restores Edge Lab. See [current integration notes](26-COLLAB-INTEGRATION.md).
